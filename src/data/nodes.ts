...
export const NODES: GalaxyNode[] = [
  // ===== ABOUT =====
  {
    ...
    oneLiner: 'Full Stack Engineer who ships agentic systems that survive production.',
    tags: ['self'],
    detail: {
      kind: 'about',
      bio: [
